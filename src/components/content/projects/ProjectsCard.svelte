<script>
  ...
  // material
  import Card, { Content as CardContent, Media as CardMedia } from '@smui/card'
  ...
  >
    <Card variant="outlined">
      <div class="jdev-project-back-wrapper">
        ...
        <CardMedia class="card-media-16x9 jdev-project-back-media {project.ident} {!project.live ? 'jdev-projects-upcoming' : ''}" aspectRatio="16x9"></CardMedia>
        <CardContent>
          {#if !project.live}
      ...
      <CardMedia class="card-media-16x9 jdev-project-front-media {project.ident} {!project.live ? 'jdev-projects-upcoming' : ''}" aspectRatio="16x9"></CardMedia>
