...
>
  ...
  <List class="jdev-project-highlights" threeLine nonInteractive>
    {#each projectData.projectPage.keys as key, i (i)}
      <Item style="animation-delay: {animationParams.content.delay + animationParams.content.iterationDelay * i}ms; cursor: default; height: auto;">
